      ...
      {trails.map((t, i) => {
        ...
        return (
          <line
            ...
            strokeLinecap="round"
            style={{
              filter: `drop-shadow(0 0 4px rgba(255,255,255,${t.life * 0.5}))`,
            }}
          />
        );
      })}
    ...
    <div className="relative w-full min-h-screen overflow-hidden bg-[#0a0a1a] flex items-center justify-center select-none">
      ...
      >
        ...
        >
          ...
          >
            <div
              ...
              style={{
                ...
                height: 6,
                background:
                  "linear-gradient(90deg, transparent, rgba(200,200,255,0.6), #aaccff, #fff)",
            ...
            <div
              ...
              style={{
                ...
                height: 20,
                background:
                  "linear-gradient(180deg, #ffd700, #b8860b, #ffd700)",
          ...
          {/* Stats */}
          <Stats highScore={12450} gamesPlayed={342} rank={127} />
        </div>
      </div>
